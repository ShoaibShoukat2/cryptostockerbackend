...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-cryptostacker-dev-key-change-in-production')
...
ROOT_URLCONF = 'cryptostacker.urls'
...
WSGI_APPLICATION = 'cryptostacker.wsgi.application'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(
        minutes=int(os.getenv('JWT_ACCESS_TOKEN_LIFETIME_MINUTES', '1440'))
    ),
...
INVESTMENT_LOCK_DAYS = int(os.getenv('INVESTMENT_LOCK_DAYS', '30'))
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@cryptostacker.com')
